...
export class Select {
    ...
    constructor(item) {
        ...
        if (item instanceof Circle) {
            ...
            view.context.stroke();
            /* --- T --- */
            view.context.fillRect(item.position.center.x - 4, item.position.y - 4, 7, 7);
            /* --- B --- */
            view.context.fillRect(item.position.center.x - 4, item.position.y + item.position.height - 4, 7, 7);
            /* --- L --- */
            view.context.fillRect(item.position.x - 4, item.position.center.y - 4, 7, 7);
            /* --- R --- */
            view.context.fillRect(item.position.x + item.position.width - 4, item.position.center.y - 4, 7, 7);
        } else {
