...
This will draw a quadratic bezier curve on the canvas!

## Usage
```ts
import { QuadraticBezierCurve } from '@ngx-canvas/core';

const quadraticBezierCurve = new QuadraticBezierCurve({}: SHAPE);

quadraticBezierCurve.apply();
```
